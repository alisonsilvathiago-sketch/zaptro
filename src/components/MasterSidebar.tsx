...
const styles: Record<string, any> = {
  ...
  logoText: { fontSize: '16px', fontWeight: '800', color: 'var(--text-main)', letterSpacing: '-0.5px' },
  ...
  avatar: { width: '30px', height: '30px', borderRadius: '8px', backgroundColor: '#0F172A', display: 'flex', alignItems: 'center', justifyContent: 'center', fontSize: '12px', fontWeight: '800', color: 'white' },
