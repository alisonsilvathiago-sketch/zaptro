...
const styles: Record<string, any> = {
  ...
  card: { backgroundColor: 'white', width: '100%', maxWidth: '440px', padding: '60px 40px', borderRadius: '40px', boxShadow: '0 40px 100px -20px rgba(124, 58, 237, 0.08)', border: '1px solid #f3e8ff' },
  header: { textAlign: 'center', marginBottom: '40px' },
  logoBox: { width: '48px', height: '48px', backgroundColor: '#8b5cf6', borderRadius: '14px', display: 'flex', alignItems: 'center', justifyContent: 'center', margin: '0 auto 20px auto' },
  title: { fontSize: '24px', fontWeight: '950', color: '#1e1b4b', letterSpacing: '-1px' },
  subtitle: { fontSize: '14px', color: '#6366f1', marginTop: '8px' },
  form: { display: 'flex', flexDirection: 'column', gap: '24px' },
  inputGroup: { display: 'flex', flexDirection: 'column', gap: '8px' },
  label: { fontSize: '12px', fontWeight: '900', color: '#4338ca', textTransform: 'uppercase', letterSpacing: '0.5px' },
  inputWrapper: { position: 'relative', display: 'flex', alignItems: 'center' },
  icon: { position: 'absolute', left: '16px', color: '#a5b4fc' },
  input: { width: '100%', padding: '16px 16px 16px 48px', borderRadius: '16px', backgroundColor: '#f5f3ff', border: '1px solid #ede9fe', fontSize: '15px', outline: 'none' },
  eyeBtn: { position: 'absolute', right: '16px', background: 'none', border: 'none', color: '#a5b4fc', cursor: 'pointer' },
  loginBtn: { padding: '18px', backgroundColor: '#8b5cf6', color: 'white', borderRadius: '16px', border: 'none', fontWeight: '900', fontSize: '16px', cursor: 'pointer', display: 'flex', alignItems: 'center', justifyContent: 'center', gap: '12px', boxShadow: '0 10px 20px -5px rgba(139, 92, 246, 0.3)' },
  footer: { marginTop: '40px', borderTop: '1px solid #f3e8ff', paddingTop: '32px', textAlign: 'center' },
  upsellText: { fontSize: '13px', color: '#6366f1', marginBottom: '16px' },
  registerBtn: { backgroundColor: 'transparent', border: '1px solid #8b5cf6', color: '#8b5cf6', padding: '12px 24px', borderRadius: '12px', fontWeight: '800', cursor: 'pointer' },
