...
const styles: Record<string, any> = {
  ...
  sidebarTitle: { fontSize: '20px', fontWeight: '700', color: 'var(--text-main)', marginBottom: '16px' },
  ...
  tabBtn: { padding: '8px 16px', borderRadius: '10px', border: 'none', fontSize: '12px', fontWeight: '600', cursor: 'pointer', backgroundColor: 'var(--bg-app)', color: 'var(--text-muted)' },
  ...
  contactName: { fontSize: '14px', fontWeight: '600', color: 'var(--text-main)', margin: 0 },
  ...
  avatarMini: { width: '40px', height: '40px', borderRadius: '12px', backgroundColor: 'var(--primary-light)', color: 'var(--primary)', display: 'flex', alignItems: 'center', justifyContent: 'center', fontWeight: '700' },
  ...
  senderName: { fontSize: '11px', fontWeight: '600', color: 'var(--text-muted)', marginLeft: '12px' },
