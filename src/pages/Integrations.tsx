...
const styles: Record<string, any> = {
  ...
  headerBadge: { display: 'flex', alignItems: 'center', gap: '8px', width: 'fit-content', padding: '6px 14px', backgroundColor: '#f5f3ff', color: 'var(--primary)', borderRadius: '30px', fontSize: '11px', fontWeight: '900', letterSpacing: '1px' },
  ...
  filterTabActive: { backgroundColor: 'var(--primary)', color: 'white', borderColor: 'var(--primary)', boxShadow: '0 4px 12px rgba(124, 58, 237, 0.2)' },
  ...
  logoBox: { width: '56px', height: '56px', borderRadius: '16px', backgroundColor: '#f8fafc', display: 'flex', alignItems: 'center', justifyContent: 'center', color: 'var(--primary)', border: '1px solid #e2e8f0' },
  ...
  statusDispo: { padding: '6px 12px', backgroundColor: '#f1f5f9', color: '#64748b', borderRadius: '20px', fontSize: '11px', fontWeight: '800' },
  apiName: { fontSize: '18px', fontWeight: '900', color: '#111827', marginBottom: '8px' },
  ...
  configBtn: { display: 'flex', alignItems: 'center', gap: '8px', padding: '10px 20px', backgroundColor: '#f8fafc', color: '#475569', border: '1px solid #e2e8f0', borderRadius: '12px', fontSize: '13px', fontWeight: '800', cursor: 'pointer' },

  modalBody: { display: 'flex', flexDirection: 'column', gap: '24px', padding: '12px' },
  modalHero: { display: 'flex', gap: '16px', alignItems: 'center', backgroundColor: '#f8fafc', padding: '20px', borderRadius: '20px' },
