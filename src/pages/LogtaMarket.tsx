...
const styles: Record<string, any> = {
  ...
  walletLabel: { fontSize: '10px', fontWeight: '700', color: '#94A3B8', textTransform: 'uppercase' as const, letterSpacing: '0.05em' },
  ...
  catBtn: { display: 'flex', alignItems: 'center', gap: '10px', padding: '12px 24px', backgroundColor: 'white', border: '1px solid #E2E8F0', borderRadius: '16px', fontSize: '14px', fontWeight: '600', color: '#64748B', cursor: 'pointer', transition: 'all 0.2s' },
  ...
  orderType: { fontSize: '11px', fontWeight: '600', color: '#94A3B8' },
  orderPrice: { marginLeft: 'auto', fontSize: '18px', fontWeight: '700', color: '#0F172A' },
  
  paymentMethod: { marginBottom: '32px' },
  pmHeader: { fontSize: '12px', fontWeight: '700', color: '#94A3B8', marginBottom: '12px' },
