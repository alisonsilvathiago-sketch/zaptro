...
const styles: any = {
  ...
  secondaryBtn: { display: 'flex', alignItems: 'center', gap: '8px', padding: '12px 24px', backgroundColor: 'white', border: '1px solid #e2e8f0', borderRadius: '14px', fontSize: '14px', fontWeight: '800', cursor: 'pointer', color: '#000000', boxShadow: '0 1px 2px rgba(0,0,0,0.05)' },
  ...
  logMain: { flex: 1 },
  logAction: { fontSize: '16px', fontWeight: '800', color: '#000000', marginBottom: '6px', display: 'flex', alignItems: 'center', gap: '8px' },
  ...
  typeBadge: { fontSize: '10px', fontWeight: '900', color: '#64748b', backgroundColor: '#ebebeb', padding: '6px 12px', borderRadius: '8px', letterSpacing: '0.5px' },
  ...
  diffTitle: { fontSize: '18px', fontWeight: '900', color: '#000000', margin: 0 },
  diffSubtitle: { fontSize: '12px', color: '#94a3b8', margin: '4px 0 0 0' },
  closeBtn: { padding: '8px 16px', backgroundColor: '#f4f4f4', border: 'none', borderRadius: '8px', fontWeight: '800', cursor: 'pointer' },
