...
const AuditLogs: React.FC = () => {
  ...
  const getSeverityStyle = (sev: string) => {
    switch(sev) {
      ...
      default: return { color: '#3b82f6', bg: '#eff6ff', icon: <CheckCircle2 size={14} /> };
    }
  };
...
const styles: any = {
  ...
  secondaryBtn: { display: 'flex', alignItems: 'center', gap: '8px', padding: '12px 24px', backgroundColor: 'white', border: '1px solid #e2e8f0', borderRadius: '14px', fontSize: '14px', fontWeight: '800', cursor: 'pointer', color: '#111827', boxShadow: '0 1px 2px rgba(0,0,0,0.05)' },
  ...
  filterBtn: { display: 'flex', alignItems: 'center', gap: '8px', padding: '14px 24px', backgroundColor: 'white', border: '1px solid #e2e8f0', borderRadius: '16px', fontSize: '14px', fontWeight: '800', cursor: 'pointer' },
  ...
  liveTag: { display: 'flex', alignItems: 'center', gap: '8px', fontSize: '11px', fontWeight: '800', color: '#10b981', backgroundColor: '#ecfdf5', padding: '8px 16px', borderRadius: '20px' },
  liveDot: { width: '8px', height: '8px', borderRadius: '50%', backgroundColor: '#10b981', boxShadow: '0 0 8px rgba(16, 185, 129, 0.5)' },
  
  logList: { padding: '0' },
  logItem: { display: 'flex', alignItems: 'center', padding: '24px 32px', borderBottom: '1px solid #f1f5f9', gap: '24px', transition: 'background 0.2s' },
  severityIndicator: { display: 'flex', alignItems: 'center', gap: '8px', padding: '8px 12px', borderRadius: '10px', fontSize: '10px', fontWeight: '900', textTransform: 'uppercase' as const, width: '100px', justifyContent: 'center' },
  logMain: { flex: 1 },
  logAction: { fontSize: '16px', fontWeight: '800', color: '#111827', marginBottom: '6px', display: 'flex', alignItems: 'center', gap: '8px' },
  hqBadge: { fontSize: '9px', backgroundColor: '#7c3aed', color: 'white', padding: '2px 6px', borderRadius: '4px', letterSpacing: '0.5px' },
  logMeta: { display: 'flex', gap: '20px' },
  metaItem: { display: 'flex', alignItems: 'center', gap: '6px', fontSize: '12px', color: '#94a3b8', fontWeight: '600' },
  detailsText: { fontSize: '13px', color: '#64748b', marginTop: '10px', lineHeight: '1.5', backgroundColor: '#f8fafc', padding: '12px', borderRadius: '12px', border: '1px solid #f1f5f9' },
  logType: { display: 'flex', alignItems: 'center', gap: '16px' },
  typeBadge: { fontSize: '10px', fontWeight: '900', color: '#64748b', backgroundColor: '#f1f5f9', padding: '6px 12px', borderRadius: '8px', letterSpacing: '0.5px' },
  detailsBtn: { border: 'none', backgroundColor: '#f8fafc', color: '#94a3b8', padding: '8px', borderRadius: '8px', cursor: 'pointer' },
  ...
  diffHeader: { padding: '24px 32px', borderBottom: '1px solid #f1f5f9', display: 'flex', justifyContent: 'space-between', alignItems: 'center' },
  diffTitle: { fontSize: '18px', fontWeight: '900', color: '#111827', margin: 0 },
  diffSubtitle: { fontSize: '12px', color: '#94a3b8', margin: '4px 0 0 0' },
  closeBtn: { padding: '8px 16px', backgroundColor: '#f8fafc', border: 'none', borderRadius: '8px', fontWeight: '800', cursor: 'pointer' },
  ...
  diffLabel: { fontSize: '11px', fontWeight: '900', color: '#94a3b8', textTransform: 'uppercase' as const },
  codeBlock: { backgroundColor: '#f8fafc', padding: '16px', borderRadius: '12px', fontSize: '12px', color: '#475569', overflowX: 'auto' as const, borderLeft: '4px solid #e2e8f0', margin: 0 }
};
