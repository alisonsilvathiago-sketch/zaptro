...
const styles = {
  ...
  tabNav: { display: 'flex', gap: '8px', padding: '6px', backgroundColor: '#f1f5f9', borderRadius: '14px', width: 'fit-content' },
  ...
  cardHeader: { position: 'relative' as const, height: '160px', backgroundColor: '#f8fafc' },
  ...
  footer: { display: 'flex', justifyContent: 'space-between', alignItems: 'center', paddingTop: '12px', borderTop: '1px solid #f1f5f9' },
  ...
  input: { padding: '14px', borderRadius: '14px', border: '1px solid var(--border)', backgroundColor: '#f8fafc', color: 'var(--text-main)', outline: 'none' },
  textarea: { padding: '14px', borderRadius: '14px', border: '1px solid var(--border)', backgroundColor: '#f8fafc', color: 'var(--text-main)', outline: 'none', height: '100px', resize: 'none' as const },
