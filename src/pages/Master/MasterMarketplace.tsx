  ...
  return (
    <div style={styles.container} className="animate-fade-in">
      ...
      <div style={styles.statsGrid}>
         ...
         <div style={styles.statCard}>
            <div style={{...styles.statIcon, backgroundColor: '#eff6ff'}}><BarChart2 size={24} color="#3b82f6" /></div>
            <div>
...
const styles = {
  ...
  primaryBtn: { backgroundColor: 'var(--primary)', color: 'white', border: 'none', padding: '12px 24px', borderRadius: '16px', fontWeight: '900', cursor: 'pointer', display: 'flex', alignItems: 'center', gap: '10px', boxShadow: '0 8px 16px rgba(124, 58, 237, 0.2)' },
  ...
  statValue: { fontSize: '24px', fontWeight: '950', color: '#111827', margin: '4px 0 0 0' },

  refinement: { backgroundColor: 'white', padding: '16px', borderRadius: '20px', border: '1px solid #e2e8f0', display: 'flex' },
  searchWrap: { display: 'flex', alignItems: 'center', gap: '12px', padding: '0 16px', borderRight: '1px solid #f1f5f9', width: '400px' },
  searchInput: { border: 'none', outline: 'none', fontSize: '14px', fontWeight: '800', color: '#111827', width: '100%' },

  mainCard: { backgroundColor: 'white', borderRadius: '32px', border: '1px solid #e2e8f0', overflow: 'hidden' },
  table: { width: '100%', borderCollapse: 'collapse' as const },
  th: { textAlign: 'left' as const, padding: '20px 32px', fontSize: '11px', fontWeight: '900', color: '#64748b', textTransform: 'uppercase' as const, letterSpacing: '1px', borderBottom: '1px solid #f1f5f9' },
  ...
  iconThumb: { width: '40px', height: '40px', backgroundColor: '#f8fafc', borderRadius: '12px', display: 'flex', alignItems: 'center', justifyContent: 'center', border: '1px solid #f1f5f9' },
  appInfo: { display: 'flex', flexDirection: 'column' as const },
  appName: { fontSize: '14px', fontWeight: '900', color: '#111827' },
  ...
  slugCode: { fontSize: '12px', fontWeight: '700', color: '#1e293b', backgroundColor: '#f1f5f9', padding: '4px 8px', borderRadius: '6px' },
