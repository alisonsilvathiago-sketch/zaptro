...
const styles: Record<string, any> = {
  ...
  title: { fontSize: '28px', fontWeight: '900', color: 'var(--primary)', letterSpacing: '-1' },
  ...
  priorityBadge: { fontSize: '10px', fontWeight: '900', padding: '4px 8px', borderRadius: '6px' },
  ...
  chatAvatar: { width: '48px', height: '48px', borderRadius: '14px', backgroundColor: 'var(--accent)', color: 'white', display: 'flex', alignItems: 'center', justifyContent: 'center', fontWeight: '800', fontSize: '18px' },
  chatTitle: { fontSize: '18px', fontWeight: '800', color: 'var(--primary)' },
