...
const styles = {
  ...
  title: { fontSize: '48px', fontWeight: '900', color: 'var(--text-main)', lineHeight: '1.2', marginBottom: '16px' },
  ...
  recommendBadge: { position: 'absolute' as const, top: '-14px', left: '50%', transform: 'translateX(-50%)', backgroundColor: 'var(--primary)', color: 'white', padding: '6px 14px', borderRadius: '20px', fontSize: '12px', fontWeight: '800' },
  ...
  price: { fontSize: '40px', fontWeight: '900', color: 'var(--text-main)' },
