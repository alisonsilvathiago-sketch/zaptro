...
const styles = {
  ...
  courseTitle: { margin: 0, fontSize: '13px', color: '#94A3B8', fontWeight: '800', textTransform: 'uppercase' as const, letterSpacing: '0.5px' },
  ...
  certBtn: { width: 'fit-content', marginTop: '8px', padding: '6px 14px', backgroundColor: 'var(--primary)', color: 'white', borderRadius: '8px', border: 'none', fontWeight: '800', fontSize: '11px', display: 'flex', alignItems: 'center', gap: '6px', cursor: 'pointer', animation: 'pulse 2s infinite' },
  ...
  tabLink: { padding: '16px 4px', border: 'none', background: 'none', color: '#94A3B8', fontWeight: '800', fontSize: '14px', cursor: 'pointer', position: 'relative' as const },
  ...
  commentBtn: { alignSelf: 'flex-end', padding: '10px 24px', backgroundColor: 'var(--primary)', color: 'white', border: 'none', borderRadius: '10px', fontWeight: '800', cursor: 'pointer' },
  ...
  cUserInitials: { width: '40px', height: '40px', backgroundColor: '#334155', borderRadius: '50%', display: 'flex', alignItems: 'center', justifyContent: 'center', fontWeight: '900', color: 'var(--primary)', fontSize: '18px' },
  cBody: { flex: 1 },
  cHeader: { display: 'flex', gap: '12px', alignItems: 'center', marginBottom: '4px' },
  cUserName: { fontSize: '14px', fontWeight: '800', color: 'white' },
  ...
  matInfo: { flex: 1 },
  matName: { margin: 0, fontSize: '15px', fontWeight: '800', color: 'white' },
  ...
  sideHeader: { padding: '24px', fontSize: '12px', fontWeight: '900', color: '#94A3B8', letterSpacing: '1px', borderBottom: '1px solid #334155' },
