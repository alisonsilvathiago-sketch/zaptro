...
const styles: Record<string, React.CSSProperties> = {
  container: { padding: 0, boxSizing: 'border-box', width: '100%', maxWidth: '100%' },
  header: { display: 'flex', justifyContent: 'space-between', alignItems: 'center', marginBottom: '40px' },
  title: { fontSize: '28px', fontWeight: '950', color: '#000000', letterSpacing: '-1px', margin: 0 },
  ...
  modalName: { margin: '0 0 4px 0', fontSize: '18px', fontWeight: '950', color: '#0F172A', letterSpacing: '-0.5px' },
  ...
  modalLabel: { fontSize: '10px', fontWeight: '950', color: '#94A3B8', display: 'block', marginBottom: '4px' },
  modalVal: { fontSize: '14px', fontWeight: '900', color: '#0F172A' },
